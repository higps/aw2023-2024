...
while not user_input == "END":
    user_input_key = input("Enter ingredient name (type 'END' to exit): ")
    
    if user_input_key == "END":
        user_input = "END"
    ...
    if user_input_value == "END":
        user_input = "END"
    # if user_input_key or user_input_value in "END":
    #     user_input = "END"

    ingredients[user_input_key] = user_input_value
